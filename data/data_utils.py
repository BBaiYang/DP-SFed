...
def get_FashionMNIST():
    '''Return MNIST train/test data and labels as numpy arrays'''
    data_train = torchvision.datasets.FashionMNIST(root=DATA_PATH, train=True,
                                                   download=True)
    data_test = torchvision.datasets.FashionMNIST(root=DATA_PATH, train=False,
                                                  download=True)
...
def get_CIFAR10():
    ...
    data_train = torchvision.datasets.CIFAR10(root=DATA_PATH, train=True, download=True)
    data_test = torchvision.datasets.CIFAR10(root=DATA_PATH, train=False, download=True)
